...
parser.add_argument('--tsv', help="input file (tab separated)")
parser.add_argument('--csv', help="input file (comma separated)")
...
if opts.tsv:
    ...
    ena_df = pd.read_csv(opts.csv)
else:
    sys.stderr.write("Please provide either --tsv or --csv input!\n")
    sys.exit(1)
